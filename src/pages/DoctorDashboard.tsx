...
const DoctorDashboard: React.FC = () => {
  ...
  useEffect(() => {
    // Simular carregamento de estatísticas específicas para médicos
    setTimeout(() => {
      setStats({
        ...
        totalRevenue: 45600, // Médicos veem receita
        averageRating: 4.8,
        newPatients: 23, // Médicos veem novos pacientes
        returningPatients: 89, // Médicos veem pacientes retornantes
      });
    }, 1000);
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-dark-900">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Estatísticas específicas para médicos */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
